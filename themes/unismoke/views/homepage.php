<main>
    <?php $this->show('banners/default'); // Home Page Main Banner. ?>
        ...
        <div class="wrapper">
            <div class="row cat-box">
                <div class="col-xs-4">
                    <div class="thumbnail">
                        <a href="category.html">
                            <h3 class="icon-diamond-1">BRANDS</h3>
                            <img src="<?php echo theme_img('cat-1.jpg');?>" alt=""/>
                        </a>
                    </div>
                </div>
                <div class="col-xs-4">
                    <div class="thumbnail">
                        <a href="category.html">
                            <h3 class="icon-gutter">E-LIQUIDS</h3>
                            <img src="<?php echo theme_img('cat-2.jpg');?>" alt=""/>
                        </a>
                    </div>
                </div>
                <div class="col-xs-4">
                    <div class="thumbnail">
                        <a href="category.html">
                            <h3 class="icon-mods">POVS & MODS</h3>
                            <img src="<?php echo theme_img('cat-3.jpg');?>" alt=""/>
                        </a>
                    </div>
                </div>
                <div class="col-xs-4">
                    <div class="thumbnail">
                        <a href="category.html">
                            <h3 class="icon-tanks">CARTOMIZERS & TANKS</h3>
                            <img src="<?php echo theme_img('cat-4.jpg');?>" alt=""/>
                        </a>
                    </div>
                </div>
                <div class="col-xs-4">
                    <div class="thumbnail">
                        <a href="category.html">
                            <h3 class="icon-leaf">DRY HERB</h3>
                            <img src="<?php echo theme_img('cat-5.jpg');?>" alt=""/>
                        </a>
                    </div>
                </div>
                <div class="col-xs-4">
                    <div class="thumbnail">
                        <a href="category.html">
                            <h3 class="icon-box">STARTER KITS</h3>
                            <img src="<?php echo theme_img('cat-6.jpg');?>" alt=""/>
                        </a>
                    </div>
                </div>
                <div class="col-xs-4 desktop-hide">
                    <div class="thumbnail">
                        <a href="category.html">
                            <h3 class="icon-flag">NEW ARRIVALS</h3>
                            <img src="<?php echo theme_img('cat-1.jpg');?>" alt=""/>
                        </a>
                    </div>
                </div>
                <div class="col-xs-4 desktop-hide">
                    <div class="thumbnail">
                        <a href="category.html">
                            <h3 class="icon-power">ACCESSORIES</h3>
                            <img src="<?php echo theme_img('cat-2.jpg');?>" alt=""/>
                        </a>
                    </div>
                </div>
